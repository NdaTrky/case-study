<template>
          <section class="container mx-auto px-4 sm:px-5 py-8 md:py-12">
            ...
            <!-- Ürün Kartları -->
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5 md:gap-6 place-items-center">
              <div v-for="deal in dealsOfTheDay" :key="deal.id" class="relative group w-full max-w-xs">
                <!-- Image Container -->
